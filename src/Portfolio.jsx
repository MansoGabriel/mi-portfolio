...
const translations = {
  en: {
    ...
    experience: {
      e1: { date: "August 2025 — Present", title: "NetSuite Consultant & Developer", company: "Witbor", desc: "Participating in NetSuite implementation and continuous improvement projects for regional clients. Diagnosing and resolving complex incidents in production environments. Designing customizations using SuiteScript 1.0, 2.0, and 2.1, including automations, validations, and custom reports. Providing technical and functional support, and creating documentation for implemented solutions." },
      e2: { date: "January 2023 — August 2025", title: "NetSuite Consultant & Developer", company: "BeApps Adistec", desc: "Participated in implementation and continuous improvement projects for regional clients. Diagnosed and resolved complex incidents in NetSuite production environments. Designed customizations using SuiteScript 1.0, 2.0, and 2.1. Provided technical and functional support, and created documentation for implemented solutions." },
      e3: { date: "December 2019 — December 2022", title: "NetSuite Developer", company: "Adistec", desc: "Developed custom SuiteScript scripts focused on process automation in finance, sales, and logistics. Created and maintained workflows (SuiteFlow) and custom forms (SuiteBuilder). Provided support to key users, handled technical tickets, and collaborated on system expansion to new countries within the Adistec group." },
    },
    projects: {
